          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: streakCount > 0 ? Colors.red.withValues(alpha: 0.15) : accentColor.withValues(alpha: 0.15),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: streakCount > 0 ? Colors.orange.withValues(alpha: 0.5) : accentColor.withValues(alpha: 0.35)),
                ),
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      streakCount > 0 ? 'x$streakCount aktif' : '$streakCount hari aktif',
                      style: TextStyle(
                        color: streakCount > 0 ? Colors.orangeAccent : accentColor,
                        fontSize: 11,
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: widget.isToday
                ? Border.all(
                    color: widget.accentColor.withValues(alpha: 0.6 + _pulseCtrl.value * 0.4),
                    width: 1.5,
                  )
                : null,
